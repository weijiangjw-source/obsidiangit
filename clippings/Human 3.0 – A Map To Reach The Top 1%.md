...
created: 2026-06-30
description: "As corny as this may sound, I've always wanted to become an absolute unit of an individual.Not just having a nice and muscular body, but to ..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HBUzlGwbcAUboWU?format=jpg&name=large)
...
> **Note**: I have created a HUMAN 3.0 Knowledge Base with nuances of the model, civilizational impact, historical context, scientific foundations, and my personal principles weaved in. If you want a comprehensive and skimmable breakdown of the entirety of the model, [read it here](https://letters.thedankoe.com/p/a-complete-knowledge-base-of-human) or paste it into AI to explore it. I’ll also link it at the end (I’d recommend reading this first).
...
![Image](https://pbs.twimg.com/media/HBS0hdea8AA3BNH?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HBS0t9sbcAUW8wX?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HBS0x6abcAUYi4G?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HBS03csaQAAS2XG?format=jpg&name=large)
...
> Ken Wilber's "pre-trans fallacy" occurs when people confuse pre-rational (Conformist) states with trans-rational (Synthesist) states because both appear "non-rational" from a conventional rational (Individualist) perspective. This can happen both [ways.One](https://ways.one/) can elevate a Level 1 primitive state to Level 3 status, and some often reduce genuine Level 3 development to being primitive [thinking.In](https://thinking.in/) other words, a "bible thumper" with lack of knowledge and experience beyond their childhood conditioning finds it difficult to take a mystic seriously, when the mystic often holds the same truths, but from a more comprehensive perspective.If it helps, think of the [IQ bell curve meme](https://knowyourmeme.com/memes/iq-bell-curve-midwit).
...
[Join here](https://letters.thedankoe.com/) if you want these articles sent directly to you, just in case the algorithm doesn't feed them to you.